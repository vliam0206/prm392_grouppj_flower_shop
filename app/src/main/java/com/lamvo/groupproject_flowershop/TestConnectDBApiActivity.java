 ...
 **/
public class TestConnectDBApiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_connect_dbapi);
        ...
        try {
            ...
            call.enqueue(new Callback<Customer[]>() {
                ...
                public void onFailure(Call<Customer[]> call, Throwable t) {
                    Toast.makeText(TestConnectDBApiActivity.this, "Load data test failed!", Toast.LENGTH_LONG).show();
                }
            });
        } catch (Exception e) {
        ...
        try {
            ...
            call.enqueue(new Callback<OrderDetail[]>() {
                ...
                public void onResponse(Call<OrderDetail[]> call, Response<OrderDetail[]> response) {
                    Toast.makeText(TestConnectDBApiActivity.this, "Load order detail data test successfully!", Toast.LENGTH_LONG).show();
                }
